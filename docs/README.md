...
| Path                                         | Why                                          |
| -------------------------------------------- | -------------------------------------------- |
| [`archive/`](./archive/)                     | Old role SCRATCHPADs + admin handoff         |
| [`runbooks/archive/`](./runbooks/archive/)   | Dated evidence (a11y pass, security smoke)   |
| [`../plans/archive/`](../plans/archive/)     | Phase checklists / devops handoffs           |
| [`superpowers/plans/`](./superpowers/plans/) | Shipped admin implementation plans (history) |
| [`superpowers/specs/`](./superpowers/specs/) | Design specs (update status line only)       |
| [`contracts/`](./contracts/)                 | Legal templates                              |
| [`sales/`](./sales/)                         | Pitch + outreach tracker                     |

## Deferred until hire

Secretary Phase B (profiles RLS, staff invite) — see SCRATCHPAD / `client-ops.md`. Do not start without an explicit ask.
