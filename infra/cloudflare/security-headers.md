...
| `Content-Security-Policy`   | `default-src 'self'; script-src 'self' 'unsafe-eval' 'unsafe-inline' https://analytics.nothing.digital https://*.vercel-scripts.com https://vercel.live https://assets.calendly.com; style-src 'self' 'unsafe-inline'; img-src 'self' data: https:; font-src 'self'; connect-src 'self' https://*.supabase.co https://*.sentry.io https://analytics.nothing.digital https://*.vercel-scripts.com https://vitals.vercel-insights.com; frame-src 'self' https://calendly.com https://*.calendly.com; frame-ancestors 'none'; base-uri 'self'; form-action 'self'; object-src 'none';` |
