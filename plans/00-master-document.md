...
| Phase 4: `nothing://` Experience | 1–2 weeks | Weeks 5–7 |
| Phase 5: Launch & Post-Launch | 1 week | Weeks 7–8 |
| **Total** | **6–8 weeks** | — |
...
│  🖥️  DESKTOP APP (Tauri)                                   │
│     Address bar: nothing://                                 │
│     Audience: Power users, brand enthusiasts                │
│     Install: Download from nothing.digital/download         │
│                                                             │
...
│     Deep links: web+nothing://                              │
│     Audience: Mobile users, "Add to Home Screen"            │
│                                                             │
│  🔗  SHARED LINKS                                           │
│     All social/email shares use https://nothing.digital     │
│     Universal resolver at /resolve?uri=...                  │
│                                                             │
└─────────────────────────────────────────────────────────────┘
```
...
**Option A — Recommended:** Build the web app first (`https://nothing.digital`). Add the Tauri desktop app as a Phase 4 enhancement. Use `nothing://` as branding in marketing materials, logos, and the desktop app address bar.

**Option B — Scope Increase:** Deprioritize or eliminate the `nothing://` display requirement. Focus entirely on the web experience. Use `nothing://` as a brand metaphor only.

**Option C — Maximum Investment:** Build both web app and Tauri desktop app in parallel from day one. Adds 1–2 weeks to timeline.

> **📝 ACTION:** Stakeholder must confirm which option before Phase 2 begins.
...
> **Duration:** 1–2 weeks  
> **Goal:** Tauri desktop app built with `nothing://` address bar.  
> **Gate:** Desktop app installs successfully, displays `nothing://`, deep links work.
> **⚠️ CONTINGENT ON:** Stakeholder confirmation of Option A or C from Section 2.

### 8.1 Tauri Desktop App

| Step | Task | Owner | Effort | Status |
|------|------|-------|--------|--------|
| 4.1 | Initialize Tauri project with Rust backend | Architect | S | 🔲 |
| 4.2 | Configure OS-level `nothing://` protocol registration | Architect | M | 🔲 |
| 4.3 | Build custom title bar with `nothing://` address bar display | Frontend | M | 🔲 |
| 4.4 | Implement deep link handler (`nothing://services/website-development`) | Architect | M | 🔲 |
| 4.5 | Package app for macOS (.dmg), Windows (.msi), Linux (.AppImage) | DevOps | M | 🔲 |
| 4.6 | Set up auto-updater (tauri-updater) | DevOps | S | 🔲 |
| 4.7 | Create download page on web app (`nothing.digital/download`) | Frontend | S | 🔲 |
| 4.8 | Sign binaries (Apple Developer ID, Windows Code Signing) | DevOps | M | 🔲 |

### 8.2 PWA Protocol Handlers (Optional)

| Step | Task | Owner | Effort | Status |
|------|------|-------|--------|--------|
| 4.9 | Add `manifest.json` with `protocol_handlers` for `web+nothing://` | Frontend | S | 🔲 |
| 4.10 | Create `/resolve` page for protocol resolution | Frontend | S | 🔲 |
| 4.11 | Add Service Worker for offline caching | Frontend | M | 🔲 |

### 8.3 Browser Extension (Optional)

| Step | Task | Owner | Effort | Status |
|------|------|-------|--------|--------|
| 4.12 | Build Chrome/Edge extension that redirects `nothing://` → `https://` | Frontend | S | 🔲 |
| 4.13 | Submit to Chrome Web Store | Frontend | S | 🔲 |

### Phase 4 Deliverables

- [ ] Tauri desktop app with `nothing://` address bar
- [ ] Signed binaries for macOS, Windows, Linux
- [ ] Download page on website
- [ ] Auto-updater configured
- [ ] PWA protocol handlers (if implemented)
...
*Document maintained by the General Contractor. Updated after each phase completion.*  
