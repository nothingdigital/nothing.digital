...
|                |                                                                                                                                                                     |
| -------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Shipped**    | Site + `/admin` CRM, Pack F/H, Umami, Calendly, Listmonk env, Resend transactional, Instantly CSV hybrid outbound, AI code (flags may be off). Details: SYSTEM-MAP. |
